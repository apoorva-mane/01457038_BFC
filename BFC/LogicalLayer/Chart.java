...
public class Chart extends ApplicationFrame{
	...
	static double bfc;
	static String title;
public Chart(String paramString,double d,double b){
	super(paramString);
	drop = d;
	bfc = b;
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(drop,"Drop Box","Drop Box");
	localDefaultCategoryDataset.addValue(bfc,"BFC","BFC");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Technique Name", "File Size (Bytes)", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
